...
export default function ProductUpdatePage() {
    ...
    }, [params.id, product?.name, product?.category, product?.price, product?.quantity, product?.description]);
    ...
    return (
        <main className="max-w-5xl w-full mx-auto p-5 flex items-center justify-center">
            <Card>
                ...
                <CardContent>
                    <form onSubmit={handleUpdate} className="flex flex-col justify-between gap-5">
                        <Field>
